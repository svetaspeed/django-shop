...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('mainapp', '0009_auto_20210616_1726'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unit', models.CharField(blank=True, max_length=50, null=True, verbose_name='Еденица измерения')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('feature', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='specs.categoryfeatures', verbose_name='Характеристика')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mainapp.category', verbose_name='Категория')),
                ('feature_key', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='specs.categoryfeatures', verbose_name='Ключ характеристики')),
            ],
        ),
    ]
