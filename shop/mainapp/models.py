...
#                   f' к значению можно добавить постфикс "часов", и как результат - значение "10 часов"'
#     )
...
#         help_text='Единица измерения для конкретного фильтраю Например "Частота процессора (Ghz).'
